class UseTrain {
    public static void main(String[] args) {
        ...
        Train t1 = new Train();
        t1.build(100, 30, 70);
        t1.reserveFirstClassSeats(15); // 50% dei posti di prima classe
        t1.reserveSecondClassSeats(15); 
        System.out.println("Ratio 1° classe: "+t1.getFirstClassOccupancyRatio()+"%"); // 50%
        System.out.println("Ratio totale: "+t1.getTotOccupancyRatio()+"%"); // 15+15 = 30, 30% di 100
        t1.deleteAllReservations();
        t1.reserveFirstClassSeats(30); 
        t1.reserveSecondClassSeats(57);
        System.out.println("Ratio 1° classe: "+t1.getFirstClassOccupancyRatio()+"%");
        System.out.println("Ratio totale: "+t1.getTotOccupancyRatio()+"%"); 
    }
}
