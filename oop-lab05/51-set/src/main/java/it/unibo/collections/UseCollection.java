...
public final class UseCollection {
    ...
    public static void main(final String[] args) {
         ...
         * will `coll` have? 
         * ANSWER: ArrayList<Integer> because it can understand the type of the Generic by the List.of() params because the compiler understands what type it needs by the context
         */
